...
def get_fee_for_payment_method(method: str) -> dict:
    ...
    the name of the payment provided by the user.
...
currency_agent = LlmAgent(
    ...
    For currency conversion requests:
        ...
        5. First, state the final converted amount.
            Then, explain how you get that result by showing the intermediate amounts. Your explanation must include: the fee percentage and its value in the original currency,
...
print(" get_free_for_payment_method - Looks up company fee structure")
...
calculation_agent = LlmAgent(
    ...
    Your task is to take a request for a calculation and translate it into single block of Python code that calculates the answer.
    **RULES:**
...
enhanced_currency_agent = LlmAgent(
    ...
    For any currency conversion request:
        ...
        You must use the calculation_agent tool to generate Python code that calculates the final converted amountl. 
        This code will use the fee information from step 1 and the exchange rate from step 2.
        5. Provide Detailed Breakdown: In your summary, you must:
            * State the fianl converted amount.
...
print(" Funciton Tools (fees, rates)")
